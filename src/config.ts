export const config = {
  ...
  typingText: "สุขสันต์วันพิเศษของเรานะ ❤️ ขอบคุณที่เข้ามาเป็นความสุขเล็ก ๆ ในทุกวันของเรา อยู่ด้วยกันไปนาน ๆ แบบนี้นะ ไม่ว่าจะวันดีหรือวันแย่ เราจะอยู่ข้างเธอเสมอ ขอให้เธอมีแต่รอยยิ้ม มีความสุขมาก ๆ และไม่ว่าจะเกิดอะไรขึ้น อย่าลืมว่ายังมีเราคอยจับมืออยู่ตรงนี้นะ 💖 และไม่ว่าจะเกิดอะไรขึ้น อย่าลืมว่ายังมีเราคอยจับมืออยู่ตรงนี้นะ 💖 และไม่ว่าจะเกิดอะไรขึ้น อย่าลืมว่ายังมีเราคอยจับมืออยู่ตรงนี้นะ 💖 และไม่ว่าจะเกิดอะไรขึ้น อย่าลืมว่ายังมีเราคอยจับมืออยู่ตรงนี้นะ 💖",
